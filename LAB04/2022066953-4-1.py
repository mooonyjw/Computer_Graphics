...
def render(): 
    ...
    #Draw local frame of the blue base
    drawFrame()
    ...
    #Draw local frame of the red base
    drawFrame()
    ...
    #Draw local frame of the green base
    drawFrame()
...
def main(): 
    if not glfw.init(): 
        return 
    window = glfw.create_window(480,480,'2022066953-4-1', None,None) 
    if not window: 
        glfw.terminate() 
        return 
